"""
Django settings for rough_frost_103 project.
...
ROOT_URLCONF = 'rough_frost_103.urls'
...
WSGI_APPLICATION = 'rough_frost_103.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Rough Frost Support <support@rough-frost-103.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "rough_frost_103 API",
    "DESCRIPTION": "API documentation for rough_frost_103 App",
    "VERSION": "v1",
}
